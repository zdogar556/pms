...
const Feed = () => {
  ...
  const feedColors = {
    Starter: " text-blue-800 border-blue-400",
    Grower: " text-green-800 border-green-400",
    Finisher: " text-yellow-800 border-yellow-400",
    Layer: " text-purple-800 border-purple-400",
    Broiler: " text-pink-800 border-pink-400",
    Medicated: " text-red-800 border-red-400",
  };
